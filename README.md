...
- LLM & NLP
- VAE / VQVAE / Flow Matching / Diffusion models / GAN
- Méthodes de tracking multi-objets
- Techniques de fusion multimodale (vision / texte)
- Projet R&D end-to-end .

## 🚀 Key Projects

### 🐭 Multi-Mouse Tracking System (Deep Learning)
- Détection & suivi multi-objets à partir de vidéos expérimentales
- Kalman Filter + Algorithme Hongrois
- Annotation anatomique & analyse des interactions sociales
- Détection dans une vidéo avec un taux de +75% 
- Résultats exportables 

### 📄 Cross-Modal Retrieval (Vision + Texte)
- Implémentation de la méthode DSCMR
- Fusion texte-image pour recherche multimodale
- Évaluation comparative et Benchmarking

### 🧠 LLMs & Process Mining
- Analyse de logs d’apprentissage
- Prédiction des actions futures avec BERT à partir d'un process données
- Interpretation des resultats
- Gestion du déséquilibre des classes des données 
...
# 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=omdrift&theme=dark&hide_border=false&include_all_commits=false&count_private=false)<br/>
![](https://nirzak-streak-stats.vercel.app/?user=omdrift&theme=dark&hide_border=false)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=omdrift&theme=dark&hide_border=false&include_all_commits=false&count_private=false&layout=compact)
