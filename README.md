...
- Résultats exportables (CSV, XML, vidéos annotées)

### 📄 Cross-Modal Retrieval (Vision + Texte)
- Implémentation de la méthode DSCMR
- Fusion texte-image pour recherche multimodale
- Évaluation comparative et amélioration des performances

### 🧠 LLMs & Process Mining
- Analyse de logs d’apprentissage
- Prédiction des actions futures avec BERT
- Gestion du déséquilibre via Focal Loss
